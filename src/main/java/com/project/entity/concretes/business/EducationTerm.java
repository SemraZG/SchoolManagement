...
public class EducationTerm {
    ...
    @OneToMany(mappedBy = "educationTerm", cascade = CascadeType.ALL)//CascadeType.ALL-->education term kaydediliyrsa lesonprogramlar da kaydedilsin silinirse silinsin
