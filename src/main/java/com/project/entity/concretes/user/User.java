...
public class User {
    ...
    @Enumerated(EnumType.STRING)//-->Enum turundeki degiskenlerin degerlerini string olrak yazdir demek
    private Gender gender; // Erkek , erkek , Erkek , Bay , bay , BAY , ERKEK

    @OneToMany(mappedBy = "teacher", cascade = CascadeType.REMOVE)//cascade = CascadeType.REMOVE->student silinirse onla ilgili studentInfo da silinsin demek
