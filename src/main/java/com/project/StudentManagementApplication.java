...
public class StudentManagementApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//!!! Built_IN ADMIN(yani hickimsenin Adminin dahi silemeyecgi admin demek) olusturacagiz
		//db'deki adminlerin sayisi sifirsa bu blok calisacak, bir tane bile varsa zaten o built-in admin dir
