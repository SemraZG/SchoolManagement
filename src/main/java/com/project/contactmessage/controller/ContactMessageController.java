...
@RestController//restapi yaptigimiz icin RestController kullndk,Controller degil
@RequestMapping("/contactMessages")
@RequiredArgsConstructor//classdaki final olan degisknlerden constrctr olusturur
public class ContactMessageController {

    private final ContactMessageService contactMessageService;
    //clientdan gelen istek dto ile karsilanir, service e kadar dto, service ile repo asamasinda ise pojo


    @PostMapping("/save")// http://localhost:8080/contactMessages + POST + JSON
