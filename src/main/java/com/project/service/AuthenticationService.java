...
public class AuthenticationService {
    ...
    public ResponseEntity<AuthResponse> authenticateUser(LoginRequest loginRequest) {
        ...
        AuthResponse.AuthResponseBuilder authResponse = AuthResponse.builder();//bu noktada yarim nesne
        ...
        return  ResponseEntity.ok(authResponse.build());//bu noktada nesne tamamlaniyor
    }
