...
public class UserController {
    ...
    public ResponseEntity<Page<UserResponse>> getUserByPage(
        ...
        return new ResponseEntity<>(adminsOrDeansOrViceDeans, HttpStatus.OK);//burasi ResponseEntity.ok() ile ayni uzun hali sadece
    }
    ...
    @PreAuthorize("hasAntAuthority('ADMIN', 'MANAGER')")
    ...
    public ResponseEntity<String> deleteUserById(@PathVariable Long id, HttpServletRequest httpServletRequest){//HttpServletRequest httpServletRequest-->istegi gonderen userin rolunu almam gerektigi icin yazdik
    ...
    // Update
    // !!! Admin --> Dean veya  ViceDEan i guncellerken kullanilacagi method
